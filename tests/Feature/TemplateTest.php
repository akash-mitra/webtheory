...
// /**
//  * Template testing is bit different from other tests. Please read the explanations.
//  *
//  * Templates are kept in 2 places with 2 separate laravel disk names. They are -
//  * (1) "store": /storage/store/
//  * (2) "template": /resources/views/templates
//  *
//  * All templates are stored in the "store" disk, whereas only active templates
//  * are stored in the "template" disk. In "store", blade are given names based
//  * on ....
//  * However, when a blade is "activated" - meaning copied over to "template"
//  * disk, the blade name is changed to its type name (e.g. single.blade.php)
//  *
//  */
