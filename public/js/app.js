...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {// util.ajax ('get', '/api/categories', {},  (response) => {
  ...
  return _c("div", { staticClass: "max-w-4xl mx-auto" }, [
    ...
    _c(
      ...
      _vm._l(_vm.filtered, function(topic) {
        return _c("div", [
          _c("div", { staticClass: "text-xl" }, [_vm._v(_vm._s(topic.name))]),
          _vm._v(" "),
              ...
              directives: [
                {
                  name: "show",
                  rawName: "v-show",
                  value: topic.children.length > 0,
                  expression: "topic.children.length > 0"
                }
              ]
            },
            _vm._l(topic.children, function(subtopic) {
              return _c("div", [
                _vm._v(
                  "\n                    " +
                    _vm._s(subtopic.name) +
                    "\n                "
                )
              ])
            }),
...
vue__WEBPACK_IMPORTED_MODULE_0___default.a.component('t-toggle', __webpack_require__(/*! ./ui/TensorToggle.vue */ "./resources/js/ui/TensorToggle.vue")["default"]); // define the route files for the vue-router
...
/*!******************************!*\
  !*** ./resources/js/auth.js ***!
  \******************************/
/*! exports provided: isProtected, loginValid, isAuthenticated, isFresh */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function isFresh() {
  ...
  if (isNaN(lastLoginAt)) return false; // add 1 hour(s) with the last login time

  var freshPeriod = 1;
  var loginValidTill = new Date(lastLoginAt + freshPeriod * 60 * 60 * 1000); // console.log('Login valid till: ' + loginValidTill);
