...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    window.document.addEventListener('keydown', this.keyboardHooks); // e.target.style.height = 'auto'
    //     e.target.style.height = e.target.scrollHeight + 'px'
    // this.$refs.intro.style.height = 'auto'

    var px = this.intro.length / 70 * 10;
    console.log(this.intro.length);
    this.$refs.intro.style.height = px + 'px';
  },
