...
/* harmony default export */ __webpack_exports__["default"] = (_props$data$created$m = {
  ...
  methods: {
    register: function register(instance) {
      ...
      console.log('registering block ', instance.holderId);
      this.instances.push(instance);
    },
    removeBlock: function removeBlock(content) {
      console.log('will remove', content.holderId);

      for (var i = 0; i < this.instances.length; i++) {
        var block = this.instances[i]; // console.log('checking', instance.holderId)

        if (block.holderId === content.holderId) {
          console.log('to be deleted', block.holderId);
          block.instance.destroy();
        }
      }
    }
  }
}, _defineProperty(_props$data$created$m, "data", function data() {
  return {
    showBlocks: false,
    blockTypes: [{
      type: 'editorjs',
...
}), _defineProperty(_props$data$created$m, "components", {
                ...
                "div",
                {
                  ...
                  on: {
                    click: function($event) {
                      return _vm.removeBlock(content)
                    }
                  }
                },
                [
