    ...
    [
      ...
      _c(
        "div",
        {
          ...
          staticClass: "w-full bg-gray-200 bg-pattern",
          attrs: { id: "page-contents" }
        },
        [
          _c("div", { staticClass: "mt-6 py-10 w-full mx-auto max-w-4xl" }, [
            _c(
              "div",
              ...
              [
                ...
                _c("textarea", {
                  ...
                  ref: "title",
                  staticClass:
                    "autoheight h-8 bg-white p-4 rounded-lg outline-none text-blue-800 text-3xl tracking-wide w-full placeholder-gray-700",
            ...
            _c(
              ...
              [
                ...
                _c("textarea", {
                  ...
                  ref: "intro",
                  staticClass:
                    "autoheight h-8 bg-white p-4 rounded-lg outline-none text-gray-700 text-lg tracking-wide w-full placeholder-gray-700",
                  attrs: {
                    name: "intro",
                    placeholder:
  ...
  function() {
    ...
    return _c(
      ...
      [
        _c("div", {
          staticClass:
            "mx-auto w-full text-gray-700 pb-4 bg-white wt-typography",
