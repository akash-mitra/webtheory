                    ...
                    [
                      _c("PhotoPicker", {
                        attrs: {
                          ...
                          "container-classes":
                            "border w-full bg-gray-100 flex items-center cursor-pointer"
                        },
                        model: {
                          value: _vm.media,
                          callback: function($$v) {
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      "label",
      {
        staticClass: "uppercase text-xs tracking-wider text-gray-700 block pb-2"
      },
      [
        _vm._v("\n                    Blog Image\n                    "),
        _c("div", [_vm._v("Add Blog Image")])
      ]
    )
  }
]
