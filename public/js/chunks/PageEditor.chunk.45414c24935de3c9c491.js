...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    reposition: function reposition(content, operation) {
      alert(content.id);

      if (operation === 0) {
        //delete
        this.contents = this.contents.filter(function (c) {
      ...
      _c(
        ...
        [
          ...
          _c("PageEditorContentBlocks", {
            ...
            on: { select: _vm.addContentBlock, reposition: _vm.reposition }
          })
        ],
        1
      ),
          ...
          _c(
            ...
            [
                ...
                "div",
                {
                  ...
                  on: {
                    click: function($event) {
                      return _vm.$emit("reposition", content, 0)
                    }
                  }
                },
                [
              ...
              content.type === "raw"
                ...
                : _vm._e(),
              _vm._v(" "),
              content.type === "editorjs" || content.type === "editor"
                ? _c("div", {
                    staticClass: "pt-4 border-l border-white hover-left-border",
                    domProps: { innerHTML: _vm._s(content.body_json) }
                  })
                : _vm._e(),
              _vm._v(" "),
              content.type === "editorjs" || content.type === "editor"
                ? _c("PageEditorJsPlus", {
                    ...
                    attrs: {
                      ...
                      "holder-id": "editor-" + index.toString()
                    },
                    on: {
