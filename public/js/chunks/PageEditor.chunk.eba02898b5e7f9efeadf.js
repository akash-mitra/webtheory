...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    util.ajax('get', '/api/pages/' + this.$route.params.id, {}, function (data) {
      ...
      _this.contents = data.content; // p.editor = p.loadEditorTool()
    ...
    [
      ...
      _c(
        ...
        [
          _c(
            "div",
            { staticClass: "pt-10 w-full max-w-5xl bg-white mx-auto" },
            [
              _c(
                "div",
              ...
              _c(
                "div",
                { staticClass: "mt-12 mx-auto max-w-5xl bg-white" },
                [
                  _c(
                    "label",
                    {
              ...
              _c(
                ...
                [
                  ...
                  content.type === "editorjs"
                    ? _c("PageEditorJs", {
                        staticClass:
                          "border-l-4 border-white hover-left-border",
                        attrs: {
