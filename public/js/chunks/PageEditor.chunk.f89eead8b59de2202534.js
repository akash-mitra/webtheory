  ...
  return _c("div", [
    _c("div", { staticClass: "w-full md:w-1/2 px-4" }, [
      ...
      _c(
        ...
        [
          _vm._v(
            "\n            Good meta descriptions are short blurbs that describe accurately the content of the\n            page. This gives Google and other search engines a summary of what the page is\n            about.\n        "
          )
        ]
      ),
      _vm._v(" "),
    ...
    _c("div", { staticClass: "w-full md:w-1/2 px-4" }, [
      ...
      _c(
        ...
        [
          _vm._v(
            "\n            This is how this page may appear in Google search when using the page meta\n            description. Search engines may use meta description as snippets for your pages or a\n            more relevant section of your page's visible text, if that fits better with a user's\n            query.\n        "
          )
        ]
      ),
      _vm._v(" "),
      _c(
        ...
        [
          ...
          _vm._v(" "),
          _c("div", { staticClass: "google-url" }, [_vm._v(_vm._s(_vm.url))]),
          _vm._v(" "),
          _c("div", { staticClass: "google-desc" }, [_vm._v(_vm._s(_vm.value))])
        ]
      )
    ])
  ])
