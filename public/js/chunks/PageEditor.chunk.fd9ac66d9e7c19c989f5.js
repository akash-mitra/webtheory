    ...
    [
      ...
      _c(
        "div",
        {
          ...
          staticClass: "w-full bg-gray-300",
        ...
        [
          _c(
            ...
            {
              staticClass:
                "mt-6 py-10 w-full mx-auto max-w-4xl bg-white border-t rounded-lg shadow"
            },
            [
              _c(
                "div",
                { staticClass: "mx-auto editor-max-width" },
                [
                  _c(
                    "label",
                    {
                  ...
                  _c("textarea", {
                    ...
                    ref: "title",
                    staticClass:
                      "autoheight h-8 bg-gray-100 p-2 rounded shadow-inner outline-none text-blue-800 text-3xl tracking-wide w-full placeholder-gray-700",
                    attrs: {
                      name: "title",
              ...
              _c(
                "div",
                { staticClass: "mt-12 mx-auto editor-max-width" },
                [
                  _c(
                    "label",
                    {
                  ...
                  _c("textarea", {
                    ...
                    ref: "intro",
                    staticClass:
                      "autoheight h-8 bg-gray-100 p-2 rounded shadow-inner outline-none text-gray-700 text-lg tracking-wide w-full placeholder-gray-700",
                    attrs: {
                      name: "intro",
                      placeholder:
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      ...
      {
        staticClass:
          "mt-6 mx-auto max-w-4xl bg-white py-10 border-t rounded-lg shadow-lg"
      },
      [
        _c("div", {
          staticClass: "mx-auto text-gray-700 pb-4 bg-white wt-typography",
