      ...
      _c(
        ...
        [
          _c(
            ...
            {
              staticClass:
                "py-10 w-full max-w-5xl bg-gray-200 mx-auto border-b rounded-lg my-4 relative"
            },
            [
              _c(
                "div",
                {
                  staticClass:
                    "absolute top-0 right-0 text-gray-600 text-xs p-4 flex justify-between z-20 bg-green-200"
                },
                [_vm._v("\n                X\n            ")]
              ),
              _vm._v(" "),
              _c("div", { staticClass: "w-full px-6 py-2 border-b -mt-8" }, [
                _vm._v("\n                Header\n            ")
              ]),
              _vm._v(" "),
              _c(
