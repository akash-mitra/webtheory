    ...
    [
      ...
      _c(
        ...
        [
          _c(
            "div",
            { staticClass: "pt-10 w-full p-6 mx-auto max-w-4xl bg-white" },
            [
              _c(
                "div",
                ...
                [
                  ...
                  _c("textarea", {
                    ...
                    ref: "title",
                    staticClass:
                      "autoheight h-8 bg-transparent border-b-2 border-gray-400 outline-none text-blue-800 text-3xl tracking-wide w-full placeholder-gray-700",
                    attrs: {
                      name: "title",
              ...
              _c(
                ...
                [
                  ...
                  _c("textarea", {
                    ...
                    ref: "intro",
                    staticClass:
                      "autoheight h-auto bg-transparent  outline-none text-gray-700 text-lg tracking-wide w-full placeholder-gray-700",
                    attrs: {
                      name: "intro",
                      placeholder:
          ...
          _vm._v(" "),
          _c("div", { staticClass: "w-full p-2 bg-pattern pb-20" })
        ]
      ),
      _vm._v(" "),
      _c(
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      ...
      {
        staticClass:
          "max-w-4xl mx-auto bg-white shadow-xl px-6 pt-12 border-t-2 border-blue-400"
      },
      [
        _c("div", {
          staticClass:
