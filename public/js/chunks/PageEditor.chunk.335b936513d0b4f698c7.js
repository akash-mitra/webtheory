...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    downContentBlock: function downContentBlock(index) {
      ...
      // display Order, only if its existing display order
      // is conflicting with the above block's display order.
    ...
    upContentBlock: function upContentBlock(index) {
      var blockAbove = this.contents[index - 1];
      blockAbove['display_order'] += 1;
      blockAbove['changed'] = true;
      var block = this.contents.splice(index, 1)[0];
      block['display_order'] -= 1;
      block['changed'] = true;
      this.contents.splice(index - 1, 0, block);
