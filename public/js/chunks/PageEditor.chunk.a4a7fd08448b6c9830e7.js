...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    downContentBlock: function downContentBlock(index) {
      // update display orders of this and next item
      // this.contents[index].display_order += 1
      // this.contents[index + 1].display_order -= 1
      this.contents.splice(index + 1, 0, this.contents.splice(index, 1)[0]);
    },
    upContentBlock: function upContentBlock(index) {
      // update display orders of this and previous item
      this.contents[index].display_order -= 1;
      this.contents[index - 1].display_order += 1;
      this.contents.splice(index - 1, 0, this.contents.splice(index, 1)[0]);
    },
    swapDisplayOrderBetweenIndices: function swapDisplayOrderBetweenIndices(idx1, idx2) {
      var t1 = this.contents[idx1].display_order;
      var t2 = this.contents[idx2].display_order; // dummy value to avoid duplicate display order issue

      this.contents[idx1].display_order = -1;
      this.contents[idx1].display_order = t2;
      this.contents[idx2].display_order = t1;
    },
