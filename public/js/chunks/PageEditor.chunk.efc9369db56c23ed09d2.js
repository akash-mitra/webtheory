  ...
  return _c(
    ...
    [
      ...
      _c(
        ...
        [
          _c("div", { staticClass: "pt-10 w-full pb-24" }, [
            _c(
              "div",
          ...
          _c(
            ...
            {
              staticClass:
                "max-w-5xl mx-auto border flex items-center justify-between"
            },
            [
              _c(
                "span",
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      ...
      {
        staticClass:
          "block appearance-none w-full bg-white hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline"
      },
      [
        _c("option", [
          _vm._v("Really long option that will likely overlap the chevron")
        ]),
        _vm._v(" "),
