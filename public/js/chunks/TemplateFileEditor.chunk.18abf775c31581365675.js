...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    fetchContentAndLoadEditor: function fetchContentAndLoadEditor() {
      ...
      if (typeof this.$route.params.id != 'undefined' && parseInt(this.$route.params.id) > 0 && typeof this.$route.params.file != 'undefined' && parseInt(this.$route.params.file) > 0) {
        util.ajax('get', '/api/templates/' + this.$route.params.id + '/get/' + this.$route.params.file, {}, function (data) {
          _this.sourceCode = data;
        });
      }
    },
