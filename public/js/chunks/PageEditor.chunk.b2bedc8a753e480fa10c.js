...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    ...
    return _ref = {
      ...
      category_id: 1,
      status: 'Draft'
    }, _defineProperty(_ref, "editor", 'editorjs'), _defineProperty(_ref, "categories", []), _defineProperty(_ref, "tab", 'content'), _defineProperty(_ref, "isSaving", false), _defineProperty(_ref, "errors", {
      title: [],
      summary: [],
      metadesc: [],
      metakey: []
