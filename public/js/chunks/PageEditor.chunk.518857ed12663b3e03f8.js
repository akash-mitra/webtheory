...
/* harmony default export */ __webpack_exports__["default"] = (_props$data$created$m = {
  ...
  methods: {
    register: function register(block) {
      console.log('registering block ', block.content.display_order);
      this.instances.push(block);
    },
    removeBlock: function removeBlock(content) {
      console.log('will remove', content.display_order, ' from', this.instances.length, ' instances'); // for (let i = 0; i < this.instances.length; i++) {
      ...
      this.$emit('deletebyorder', content);
    }
  }
      ...
      _c(
        ...
        [
          ...
          _vm._l(_vm.contents, function(c) {
            return _c("div", { staticClass: "py-3 flex w-full" }, [
              _c("div", { staticClass: "w-1/2" }, [
                _vm._v(_vm._s(c.body_html.substr(100)))
              ]),
              _vm._v(" "),
              _c("div", { staticClass: "w-1/2 truncate" }, [
                _vm._v(_vm._s(c.body_json.substr(100)))
              ])
            ])
          })
        ],
