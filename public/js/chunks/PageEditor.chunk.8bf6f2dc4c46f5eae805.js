          ...
          _c("div", { staticClass: "pt-10 w-full p-6 pb-24" }, [
            _c("div", { staticClass: "mx-auto max-w-4xl" }, [
              ...
              _c("textarea", {
                ...
                ref: "title",
                staticClass:
                  "autoheight px-6 bg-transparent border-b-2 border-gray-400 h-24 outline-none text-blue-800 text-3xl tracking-wide w-full",
            ...
            _c("div", { staticClass: "mt-12 mx-auto  max-w-4xl" }, [
              ...
              _c("textarea", {
                ...
                staticClass:
                  "bg-gray-100 rounded-lg p-6 bg-transparent h-24 outline-none text-gray-700 text-lg tracking-wide w-full",
                attrs: {
                  name: "intro",
                  placeholder:
