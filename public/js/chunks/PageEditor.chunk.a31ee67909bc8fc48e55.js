              ...
              _c(
                ...
                [
                  ...
                  _c("textarea", {
                    ...
                    ref: "title",
                    staticClass:
                      "autoheight h-8 px-6 bg-transparent border-gray-400 outline-none text-blue-800 text-3xl tracking-wide w-full placeholder-gray-700",
                    attrs: {
                      name: "title",
                ...
                [
                  _c("PhotoPicker", {
                    attrs: {
                      ...
                      "container-classes":
                        "w-full bg-gray-100 flex items-center p-6 border cursor-pointer"
                    },
                    model: {
                      value: _vm.media,
                      callback: function($$v) {
