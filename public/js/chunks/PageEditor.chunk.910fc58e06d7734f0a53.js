      ...
      _c(
        ...
        [
          _c(
            ...
            {
              staticClass:
                "w-full max-w-5xl bg-white mx-auto border rounded-lg my-4 pb-10 shadow"
            },
            [
              _c(
                "div",
                {
                  staticClass:
                    "w-full px-6 py-2 border-b mb-8 bg-gray-100 text-gray-800 text-sm uppercase rounded-t-lg",
                  on: {
