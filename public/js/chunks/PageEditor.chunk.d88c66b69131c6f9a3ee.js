  ...
  created: function created() {
    ...
    if (this.isNewPage()) {
      ...
      util.ajax('get', '/api/pages/' + this.$route.params.id, {}, function (data) {
        ...
        } // resize the intro field


        var px = (_this.intro.length / 70 + 1) * 30;
        console.log('content length:  ', _this.intro.length);
        _this.$refs.intro.style.height = 160 + 'px'; // console.log(this.$refs.intro)
        // hide the header
              ...
              _c(
                ...
                [
                  ...
                  _c("textarea", {
                    ...
                    ref: "title",
                    staticClass:
                      "autoheight h-auto px-6 bg-gray-100 border rounded outline-none text-blue-800 text-3xl tracking-wide w-full placeholder-gray-700",
                    attrs: {
                      name: "title",
                ...
                [
                  ...
                  _c(
                    "div",
                    {
                      ...
                      staticClass: "mx-auto border rounded max-w-2xl"
                    },
                    [
                      _c("PhotoPicker", {
                        attrs: {
                          ...
                          "container-classes":
                            "w-full bg-gray-100 flex items-center cursor-pointer"
                        },
                        model: {
                          value: _vm.media,
                          callback: function($$v) {
              ...
              _c(
                ...
                [
                  ...
                  _c("textarea", {
                    ...
                    ref: "intro",
                    staticClass:
                      "autoheight h-auto px-6 bg-gray-100 border rounded outline-none text-gray-700 text-lg tracking-wide w-full placeholder-gray-700",
                    attrs: {
                      name: "intro",
                      placeholder:
