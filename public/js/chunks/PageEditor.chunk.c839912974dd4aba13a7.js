      ...
      _c(
        ...
        [
          _c(
            ...
            {
              staticClass:
                "w-full max-w-5xl bg-white mx-auto border-b rounded-lg my-4"
            },
            [
              _c("div", { staticClass: "w-full px-6 py-2 border-b" }, [
                _vm._v("\n                Header\n            ")
              ]),
              _vm._v(" "),
              _c(
                "div",
                { staticClass: "w-full mx-auto max-w-2xl pt-8" },
                [
                  _c(
                    "label",
                    {
              ...
              _c(
                "div",
                { staticClass: "mt-12 mx-auto max-w-2xl pt-8" },
                [
                  _c(
                    "label",
                    {
