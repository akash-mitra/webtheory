...
/* harmony default export */ __webpack_exports__["default"] = (_props$data$methods$d = {
  props: {
    contents: {
      type: Array
    }
  ...
  methods: {
    registerBlockInstance: function registerBlockInstance(instance) {
      // console.log('register block ')
      console.log('register block ', instance.holderId);
    ...
    removeBlock: function removeBlock(index) {
      ...
      for (var i = 0; i < this.instances.length - 1; i++) {
        ...
        if (instance.holderId === 'editor-' + index) {
          console.log('to be deleted', instance.holderId);
        }
      }
    }
  }
}, _defineProperty(_props$data$methods$d, "data", function data() {
  return {
    showBlocks: false,
    blockTypes: [{
      type: 'editorjs',
...
}), _defineProperty(_props$data$methods$d, "components", {
