...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    bgImage: function bgImage() {
      // background-image: url('@if(! empty($data->pages[0]->media)){{$data->pages[0]->media->url}}@else https://source.unsplash.com/400x300?abstract,{{$data->ref->template->primaryColor}} @endif')
      return {};
    }
  }
});
