      ...
      _c(
        ...
        [
          ...
          _c(
            ...
            {
              staticClass:
                "w-full max-w-5xl mx-auto p-3 border flex flex-wrap items-center justify-between bg-yellow-100"
            },
            _vm._l(_vm.blockTypes, function(type) {
              return _c("div", { staticClass: "w-1/2 md:w-1/3 lg:w-1/4" }, [
