...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    reorder: function reorder(order) {
      ...
      var idx = this.contents.map(function (c) {
        c.display_order;
      }).indexOf(order);
      console.log(idx); // remove the element

      var removed = this.contents.splice(idx + 1, 1)[0];
      console.log(removed); //this.moveContents(0, 1)
      // this.contents.splice(0, 1)
    },
    moveContents: function moveContents(from, to) {
      this.contents.splice(to, 0, this.contents.splice(from, 1)[0]);
    }
  } // end of methods
                ...
                "div",
                {
                  ...
                  on: {
                    click: function($event) {
                      return _vm.$emit("reposition", content)
                    }
                  }
                },
                [
