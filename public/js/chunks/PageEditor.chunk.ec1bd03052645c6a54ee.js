    ...
    [
      ...
      _c(
        "div",
        {
          ...
          staticClass: "w-full bg-pattern",
          attrs: { id: "page-contents" }
        },
        [
          _c(
            "div",
            { staticClass: "pt-10 w-full mx-auto max-w-4xl bg-white" },
            [
              _c(
                "div",
              ...
              _c(
                ...
                [
                  ...
                  _c("textarea", {
                    ...
                    ref: "intro",
                    staticClass:
                      "autoheight h-auto bg-gray-100 p-2 rounded shadow-inner outline-none text-gray-700 text-lg tracking-wide w-full placeholder-gray-700",
                    attrs: {
                      name: "intro",
                      placeholder:
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      "div",
      { staticClass: "mt-12 mx-auto max-w-5xl bg-white px-6 py-12 rounded" },
      [
        _c("div", {
