        ...
        [
          ...
          _vm._l(_vm.contents, function(content) {
            return _c("div", { staticClass: "w-full" }, [
              _c(
                "div",
                { staticClass: "max-w-5xl bg-white mx-auto pb-4 border-b" },
                [
                  content.type === "raw"
                  ...
                  content.type === "editorjs"
                    ? _c("PageEditorJsPlus", {
                        staticClass: "border-l border-white hover-left-border",
                        attrs: {
          ...
          _vm._v(" "),
          _c("div", { staticClass: "w-full max-w-5xl mx-auto -mt-1" }, [
            _c(
              "div",
              {
                staticClass:
                  "px-3 py-2 bg-white rounded-lg rounded-t-none inline-block",
                on: {
              ...
              scopedSlots: _vm._u([
                {
                  ...
                  fn: function() {
                    return [
                      _c(
                        "p",
                        { staticClass: "text-xl text-gray-600 px-6 py-4" },
                  ...
                  fn: function() {
                    return [
                      _c(
                        ...
                        {
                          staticClass:
                            "px-6 py-2 text-white bg-green-600 rounded"
                        },
                        [
                          _vm._v(
                            "\n                    Copy Image Link\n                "
              ...
              directives: [
                {
                  name: "show",
                  rawName: "v-show",
                  value: _vm.showBlocks,
                  expression: "showBlocks"
                }
              ],
              staticClass:
                "w-full max-w-5xl mx-auto mt-2 flex flex-wrap items-center justify-start"
            },
            _vm._l(_vm.blockTypes, function(bt) {
              return _c("div", { staticClass: "w-1/2 md:w-1/3 lg:w-1/4 p-3" }, [
                _c("div", { staticClass: "bg-white rounded-lg shadow p-4" }, [
                  _vm._v(
                    "\n                    " +
                      _vm._s(bt.header) +
                      "\n                "
