              ...
              [
                _vm.title
                  ? _c(
                      ...
                      {
                        staticClass:
                          "bg-gray-100 rounded-lg py-1 px-4 text-xs text-right",
                        class:
                ...
                _c("textarea", {
                  ...
                  ref: "title",
                  staticClass:
                    "border-l-8 autoheight h-8 px-0 md:px-6 bg-transparent outline-none text-blue-800 text-3xl tracking-wide w-full placeholder-gray-700",
