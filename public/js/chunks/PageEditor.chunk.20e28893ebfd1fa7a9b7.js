          ...
          _c("div", { staticClass: "pt-10 w-full p-6 pb-24" }, [
            _c("div", { staticClass: "mx-auto max-w-4xl" }, [
              _c("textarea", {
                ...
                ref: "title",
                staticClass:
                  "autoheight h-8 px-0 md:px-6  bg-transparent outline-none text-blue-800 text-3xl tracking-wide w-full placeholder-gray-700",
            ...
            _c("div", { staticClass: "mt-10 mx-auto  max-w-4xl" }, [
              _c("textarea", {
                ...
                staticClass:
                  "autoheight h-8 px-0 md:px-6  bg-transparent outline-none text-gray-700 text-xl tracking-wide w-full placeholder-gray-700",
                attrs: {
                  name: "intro",
                  placeholder:
