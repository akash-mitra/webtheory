          ...
          _c("div", { staticClass: "pt-10 w-full p-6 pb-24" }, [
            _c("div", { staticClass: "mx-auto max-w-4xl" }, [
              _c("textarea", {
                ...
                ref: "title",
                staticClass:
                  "autoheight h-8 px-0 md:px-6 max-w-4xl bg-transparent outline-none text-blue-800 text-3xl tracking-wide w-full placeholder-gray-700",
              ...
              _c(
                "div",
                { staticClass: "w-full flex justify-between py-1" },
                [
                  _c("t-error-message", {
                  ...
                  _vm.title
                    ? _c(
                        ...
                        {
                          staticClass:
                            "bg-gray-100 rounded-lg py-1 px-4 text-xs",
                          class:
                            _vm.title && _vm.title.length > 100
                              ? "text-red-400"
                              : "text-gray-600"
                        },
            ...
            _vm._v(" "),
            _c("div", { staticClass: "mt-10 mx-auto  max-w-4xl" }, [
              _c("textarea", {
                directives: [
                  {
                    name: "model",
                ...
                staticClass:
                  "autoheight h-8 px-0 md:px-6 max-w-4xl bg-transparent outline-none text-gray-700 text-xl tracking-wide w-full placeholder-gray-700",
                attrs: {
                  name: "intro",
                  placeholder:
