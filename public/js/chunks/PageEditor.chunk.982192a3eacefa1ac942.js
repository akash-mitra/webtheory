  ...
  methods: {
    ...
    removeContentBlock: function removeContentBlock(content) {
      ...
      for (var i = 0; i < this.contents.length; i++) {
        ...
        console.log('inspecting ', c.display_order);

        if (c.display_order === content.display_order) {
          console.log('found', c.display_order);
          index = i;
          break;
        }
      } // console.log('tracking display order', display_order, '. removing', index)
      ...
      _c(
        ...
        [
          ...
          _c("PageEditorContentBlocks", {
            ...
            on: {
              select: _vm.addContentBlock,
              deletebyorder: _vm.removeContentBlock
            }
          }),
          _vm._v(" "),
          _vm._l(_vm.contents, function(c) {
            return _c("div", { staticClass: "py-3 flex w-full text-xs" }, [
              _c("div", { staticClass: "w-1/2" }, [
                _vm._v(_vm._s(c.body_html))
              ]),
              _vm._v(" "),
              _c("div", { staticClass: "w-1/2" }, [
                _vm._v(_vm._s(JSON.stringify(c.body_json).substr(0, 150)))
              ])
            ])
          })
        ],
