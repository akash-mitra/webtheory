...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    removeContentBlock: function removeContentBlock(display_order) {
      ...
      for (var i = 0; i < this.contents.length; i++) {
        ...
        if (c.display_order === display_order) {
...
/* harmony default export */ __webpack_exports__["default"] = (_props$data$created$m = {
  ...
  methods: {
    ...
    removeBlock: function removeBlock(content) {
      console.log('will remove', content.display_order, ' from', this.instances.length, ' instances');
      ...
      this.$emit('deletebyorder', content.display_order);
    }
  }
