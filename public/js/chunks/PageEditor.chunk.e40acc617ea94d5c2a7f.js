      ...
      _c(
        ...
        [
          ...
          _c(
            ...
            {
              staticClass:
                "w-full max-w-5xl mx-auto py-4 border md:flex flex-wrap items-center justify-between bg-yellow-100"
            },
            _vm._l(_vm.blockTypes, function(type) {
              return _c(
                "div",
                {
                  staticClass: "w-full md:w-1/3 bg-white rounded-lg shadow p-4"
                },
                [
                  _vm._v(
                    "\n                " +
