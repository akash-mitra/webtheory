    ...
    _c(
      ...
      [
        _c("div", { staticClass: "text-lg text-gray-800 pb-2" }, [
          _vm._v("Manage Template Files")
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "text-sm text-gray-800 pb-4" }, [
          _vm._v(
            "\n            Template files in HTML format are stored here. You can edit or add new files for this template.\n        "
          )
        ]),
        _vm._v(" "),
        _c("table", { staticClass: "table-auto w-full text-xs mb-2" }, [
          ...
          _c(
            "tbody",
            _vm._l(_vm.template.files, function(file) {
              return _c("tr", [
        ...
        directives: [
          {
            name: "show",
            rawName: "v-show",
            value: _vm.tab === "editor",
            expression: "tab==='editor'"
          }
        ],
