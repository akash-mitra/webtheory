...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    registerBlockInstance: function registerBlockInstance() {
      console.log('register block '); // console.log('register block ', instance.holderId)
    }
  },
  data: function data() {
    return {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    initEditor: function initEditor() {
      ...
      console.log('init edit call');

      if (!this.editor) {
        console.log('initiating with ' + this.holderId);
        ...
        this.$emit('ready'); // this.$emit('ready', { holderId: this.holderId, editor: this.editor })
      }
    }
  }
});
              ...
              content.type === "editorjs" || content.type === "editor"
                ? _c("PageEditorJsPlus", {
                    ...
                    on: {
                      ...
                      ready: _vm.registerBlockInstance
                    }
                  })
                : _vm._e()
            ],
