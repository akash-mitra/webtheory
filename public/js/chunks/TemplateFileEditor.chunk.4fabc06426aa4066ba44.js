...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    this.mode = typeof this.$route.params.file === 'undefined' ? 'edit' : 'create';
    console.log(this.$route.params.file);
    console.log(_typeof(this.$route.params.file));
  ...
  methods: {
    ...
    fetchContentAndLoadEditor: function fetchContentAndLoadEditor() {
      ...
      if (typeof this.$route.params.id != 'undefined' && parseInt(this.$route.params.id) > 0 && typeof this.$route.params.file != 'undefined') {
        this.templateName = this.$route.params.file;
      ...
      [
        _vm.mode === "edit"
          ...
          : _c("input", {
              ...
              staticClass: "text-gray-600 text-2xl border-b",
              attrs: { type: "text" },
