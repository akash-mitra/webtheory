        ...
        [
          ...
          _vm._l(_vm.contents, function(content) {
            return _c("div", { staticClass: "w-full" }, [
              _c(
                "div",
                { staticClass: "max-w-5xl bg-white mx-auto border-b" },
                [
                  content.type === "raw"
          ...
          _c(
            ...
            {
              staticClass:
                "w-full max-w-5xl mx-auto -mt-1c flex justify-end mb-10"
            },
            [
              _c(
                "div",
                {
                  staticClass:
                    "px-3 py-2 bg-white rounded-lg rounded-t-none inline-block cursor-pointer text-blue-500",
                  on: {
