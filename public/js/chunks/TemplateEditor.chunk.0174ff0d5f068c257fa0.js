        ...
        _c("div", { staticClass: "w-full sm:flex my-4 border-t px-6 py-6" }, [
          ...
          _c(
            ...
            _vm._l(_vm.parameters, function(param, key) {
              return _c(
                "div",
                { staticClass: "w-full md:flex1 items-center border-b1 p-3" },
                [
                  _c("div", { staticClass: "w-full dcmd:w-1/3" }, [
                    _c("code", [_vm._v(_vm._s(param.name))])
                  ]),
                  _vm._v(" "),
                  _c("div", { staticClass: "w-full dcmd:w-2/3" }, [
                    param.type === "text"
                      ? _c("input", {
                          directives: [
                            {
                      ...
                      : _c(
                          "select",
                          {
                            ...
                            staticClass:
                              "w-full max-w-lg text-sm px-2 py-1 rounded bg-white border focus:outline-none",
                            on: {
