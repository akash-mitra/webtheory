    ...
    initiateSave: function initiateSave() {
      ...
      if (this.isValid(true)) {
        ...
        this.editor.save().then(function (bodyJson) {
          util.ajax(_this2.getSaveMethod(), _this2.getSaveUrl(), {
            id: _this2.id,
            title: _this2.title,
            summary: _this2.intro,
            body_json: JSON.stringify(bodyJson),
            metakey: _this2.metakey,
            metadesc: _this2.metadesc,
            category_id: _this2.category_id,
            media_id: !!_this2.media ? _this2.media.id : null,
            status: _this2.status,
            editor: _this2.EDITOR_IDENTITY
          }, _this2.postSaveProcessing, _this2.handle4xxError, _this2.handle5xxError);
