...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    reorder: function reorder(order) {
      console.log(order); // when up is pressed, we need to reduce the
      // display order of the selected content and
      // increase the display order of the content
      // before it.

      this.contents.map(function (c) {
        console.log(c.id + '-' + c.display_order);
      });
      this.contents.map(function (c) {
        if (c.display_order === order) c.display_order -= 1;else if (c.display_order === order - 1) c.display_order += 1;
      });
      this.contents.map(function (c) {
        console.log(c.id + '-' + c.display_order);
      }); // search the content with the given order
    }
  } // end of methods
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _vm._l(_vm.orderedContents, function(content) {
                ...
                "div",
                {
                  ...
                  on: {
                    click: function($event) {
                      return _vm.$emit("up", content.display_order)
                    }
                  }
                },
                [
              ...
              content.type === "editorjs" || content.type === "editor"
                ? _c("PageEditorJsPlus", {
                    ...
                    attrs: {
                      ...
                      "holder-id": content.display_order.toString()
                    },
                    on: {
