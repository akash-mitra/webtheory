...
/* harmony import */ var _PageEditorJs_vue__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./PageEditorJs.vue */ "./resources/js/components/PageEditorJs.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    PageEditorJs: _PageEditorJs_vue__WEBPACK_IMPORTED_MODULE_7__["default"]
  },
  data: function data() {
    return {
      id: 0,
    ...
    fetchContentAndLoadEditor: function fetchContentAndLoadEditor() {
      if (this.isNewPage()) {
        ...
        util.ajax('get', '/api/pages/' + this.$route.params.id, {}, function (data) {
          ...
          p.media = data.media;
          p.contents = data.content; // p.editor = p.loadEditorTool()
        });
      }
    },
              ...
              return _c(
                ...
                [
                  ...
                  content.type === "editorjs"
                    ? _c("PageEditorJs", { attrs: { content: content } })
                    : _vm._e()
                ],
                1
              )
...
var render = function() {
  ...
  return _c("div", [
    _c("div", {
      ref: "editorjs",
      staticClass: "mx-auto text-gray-700 pb-4 bg-white -mr-2 wt-typography"
    })
  ])
}
var staticRenderFns = []
