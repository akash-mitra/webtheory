...
<div class="overflow-auto"
    ...
    @endif
        ...
        @if($data->ref->login->providers->google === 'Enabled'
        || $data->ref->login->providers->facebook === 'Enabled'
        || $data->ref->login->providers->twitter === 'Enabled')
        ...
        <div class="px-6 py-2 border-b kiwi rounded-b">
            ...
            <div class="pt-6 pb-4 px-6 flex items-center justify-around">
                ...
                @if(($data->ref->login->providers->facebook === 'Enabled'))
                ...
                @if(($data->ref->login->providers->twitter === 'Enabled'))
