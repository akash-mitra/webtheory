    ...
    <div class="bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg text-left" @click.stop>
        ...
        <div class="px-6 py-2 border-b kiwi rounded-b">
            ...
            <div class="pt-6 pb-4 px-6 flex items-center justify-around">
                ...
                @if(($data->ref->login->socialprovider->google === 'Enabled'))
                <a href="{{ route('social.login', 'google') }}" class="p-2 cursor-pointer text-center flex flex-col items-center text-gray-500 hover:text-red-600 mx-2">
                ...
                <a href="{{ route('social.login', 'facebook') }}" class="p-2 cursor-pointer text-center flex flex-col items-center text-gray-500 hover:text-blue-700 mx-2">
                ...
                <a href="{{ route('social.login', 'twitter') }}" class="p-2 cursor-pointer text-center flex flex-col items-center text-gray-500 hover:text-blue-500 mx-2">
