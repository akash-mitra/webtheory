            ...
            <div class="p-6 w-full lg:w-2/3">
                <div class="pb-4">
                    ...
                    <input
                        ...
                        class="w-full max-w-2xl p-2 my-2 rounded appearance-none bg-gray-200 focus:bg-white border focus:outline-none"
                    />
                    <p class="text-xs text-gray-600">
                        This is a human readable name of your website. <br />
                        For example, if your website URL is profoundmelon.com, this can be "Profound
                        Melon". <br />
                    </p>
                </div>
                ...
                <div class="pb-4">
                    ...
                    />
                    <p class="text-xs text-gray-600">
                        The site title is applicable to your entire site and not specific to a page.
                        Site title is visible in the browser window. <br />This can be same or
                        different from the <code>sitename</code>.
                    </p>
                </div>
                ...
                <div class="pb-4">
                    ...
                    <textarea
                        ...
                        v-model="sitedesc"
                        ref="sitedesc"
                        placeholder="Daily journals, ideas, viewpoints and photos of Mr. John Doe"
                        class="w-full max-w-2xl p-2 my-2 rounded appearance-none bg-gray-200 focus:bg-white border focus:outline-none"
                    ></textarea>
                    <p class="text-xs text-gray-600">
                        Provide a short but accurate description about what this site is about. This
                        information may be utilised by search bots.
                    </p>
                </div>
            </div>
            ...
            <div class="p-6 w-full lg:w-1/3">
                <div>
                    ...
                    <div class="py-4 text-sm text-gray-700">
                        A sitelogo can be used in the templates or inside any communications from
                        your website.
                    </div>
                </div>
                <div class="border-t py-6">
                    ...
                    <div class="py-4 text-sm text-gray-700">
                        ...
                        <code class="bg-gray-100 font-mono p-1">png</code> image of dimension
                        <i>32px by 32px</i>.
                    </div>
                </div>
            </div>
