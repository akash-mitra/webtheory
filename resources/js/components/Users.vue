<template>
    ...
    <div class="max-w-4xl mx-auto mb-12">
        ...
        <div class="px-6 w-full flex justify-start items-center my-8 rounded-lg">
            <div id="all-tab" @click="filterByTab('all')" class="px-6 py-2 rounded-l-full text-sm uppercase cursor-pointer" :class="tab==='all'? 'bg-white shadow-inner': 'border text-gray-500 bg-gray-100'">All</div>
            <div id="unverified-tab" @click="filterByTab('unverified')" class="px-6 py-2 rounded-none text-sm uppercase cursor-pointer flex items-center" :class="tab==='unverified'? 'bg-white shadow-inner': 'border text-gray-500 bg-gray-100'">
            ...
            <div id="banned-tab" @click="filterByTab('banned')" class="px-6 py-2 rounded-r-full text-sm uppercase cursor-pointer flex items-center" :class="tab==='banned'? 'bg-white shadow-inner': 'border text-gray-500 bg-gray-100'">
