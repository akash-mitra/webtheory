        ...
        <div class="px-6 w-full flex justify-between items-center my-8 border-b">
            <div class="w-full flex justify-between">
                ...
                <div
                    ...
                    @click="tab = 'available'"
                    class="ml-2 px-4 text-sm tracking-wide uppercase cursor-pointer"
                    :class="
                        tab === 'available'
                            ? 'text-gray-700 py-2 border-b-4 border-blue-500'
                            : 'text-gray-500 py-2'
                ...
                <div class="bg-white shadow-lg relative overflow-hidden">
                    <div class="w-full flex justify-right absolute top-0 py-6 px-8">
                        <svg
                            ...
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 469 469"
                            class="fill-current w-8 h-8 p-1 bg-green-500 text-white text-xs rounded-full shadow-lg font-bold border border-white uppercase"
                        >
                            <path
                    ...
                    <div
                        ...
                        style="min-height: 250px; min-width: 400px;"
                    >
                        <img
                        ...
                        <div class="w-full flex items-center">
                            ...
                            <div class="w-1/2 flex justify-end">
                                <t-button
                                    ...
                                    @click.native="activate(template)"
                                    color="blue"
                                >
                                    Activate
                                </t-button>
                                <div v-else class="flex items-center text-green-500">
                                    <svg
                                        ...
                                        xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 469 469"
                                        class="mr-3 fill-current w-8 h-8 p-1 bg-green-500 text-white text-xs rounded-full shadow-lg font-bold border border-white uppercase"
                                    >
                                        <path
                                            d="M463 96l-22-22c-9-8-24-8-33 0L180 302 61 183c-9-9-24-9-33 0L7 205c-9 9-9 23 0 32l157 158a23 23 0 0032 0l266-266c9-9 9-24 1-33z"
                                        />
            ...
            <div v-for="template in templates.available" class="w-full sm:w-1/2 p-3 lg:p-6">
                <div class="bg-white shadow-lg relative overflow-hidden">
                    ...
                    <div class="w-full p-6 flex flex-col justify-around">
                        ...
                        <div class="w-full flex items-center">
                            <div class="w-1/2">
                                <span class="px-3 py-1 rounded-lg text-sm bg-gray-200 border"
                                    >Version {{ template.version }}</span
                                >
                            </div>
                            <div class="w-1/2 flex justify-end">
                                <t-button
                                    :id="'install-template-' + template.id"
                                    :loadingWheel="isSaving"
                                    @click.native="installTemplate(template)"
                                    color="blue"
                                >
                                    Install Now
                                </t-button>
