    ...
    <div>
        ...
        >
            ...
            <div class="pt-4 px-6 w-full">
                <div class="text-sm">
                    Create a new template by uploading a single archieve file (.zip file) that
                    contains all the template files inside it.
                </div>
                ...
                <div class="w-full px-6 py-2 my-2 bg-gray-100 rounded-lg">
                    <div class="">
                        ...
                        <input
                            type="text"
                            class="block w-full px-3 py-1 border rounded"
                            v-model="name"
                            placeholder="Template Name"
                        />
                        <div class="text-sm text-gray-600 italic mt-1">
                            Template name can only contain letters, numbers, underscore and dash
                        </div>
                    </div>
