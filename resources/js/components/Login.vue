<template>
    ...
    <div class="absolute top-0 left-0 h-screen w-screen flex items-center justify-center bg-pattern">
        <div class="max-w-md mx-auto w-full bg-white border rounded-lg p-8 shadow-2xl">
            ...
            <div class="flex flex-row justify-center font-semibold py-2 px-6 mt-8">
                <a href="javascript:void(0)" @click="onSocialLogin('facebook')" class="mr-6 facebook" title="Facebook">
                ...
                <a href="javascript:void(0)" @click="onSocialLogin('twitter')" class="mr-6 twitter" title="Twitter">
                    <svg class="h-10 w-10 text-blue-500" viewBox="0 0 20 20">
                ...
                <a href="javascript:void(0)" @click="onSocialLogin('linkedin')" class="mr-6 linkedin" title="Linkedin">
                ...
                <a href="javascript:void(0)" @click="onSocialLogin('google')" class="google" title="Google">
                    <svg class="h-10 w-10 text-blue-500" viewBox="0 0 20 20">
