    ...
    <div>
        <div v-if="tab==='info'" class="w-full my-2 px-12 py-3 rounded-lg">
            ...
            <div class="my-2">
                ...
                <div class="mb-2">
                    <span @click="tab='password'" class="text-blue-600 cursor-pointer inline-block">Change Current Password</span>
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        save() {
            ...
            Tensor.xpatch('/api/profile', data, (response) => {
        ...
        resetPassword () {
            ...
            Tensor.xpatch ('/api/users/password', data, function (response) {
