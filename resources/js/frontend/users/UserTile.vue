    ...
    <div class="w-full user-pattern rounded-lg shadow">
        ...
        <div class="flex flex-col sm:flex-row sm:justify-start items-center p-6">
            ...
            <div class="text-center sm:text-justify">
                <div class="text-3xl text-gray-700">{{ user.name }}</div>
                <div class="text-lg text-gray-800">Joined {{ user.created_ago }} • {{ user.role }}</div>
            </div>
        </div>
        <div class="bg-white p-6">
            <div class="px-6 py-2 text-xl uppercase 1border-b text-gray-700">About Me</div>
