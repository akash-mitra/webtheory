<template>
    <div class="relative inline-block cursor-pointer focus:outline-none" @click.stop tabindex="-10">
        <div
            id="user-strip"
            @click="openMe"
            class="inline-flex justify-center items-center w-full rounded py-2 text-sm font-medium transition ease-in-out duration-150"
        >
            <span class="flex items-center px-4">
                <img :src="user.avatar" class="h-12 w-12 rounded-full" />
                <span class="hidden sm:flex ml-4 text-lg" :class="textColorClass">{{
                    user.name
                }}</span>
            </span>
            <svg
                class="ml-1 pr-2 h-5 w-5"
            ...
            <div class="rounded bg-white border shadow-xs">
                ...
                <div class="border-b">
                    <a
                        id="user-profile"
                        :href="user.url"
                        class="flex justify-between items-center px-4 py-4 tracking-wide text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus:bg-gray-100 focus:text-gray-900"
                    >
                        <span>Profile</span>
                        <svg
                ...
                <div class="bg-gray-100">
                    <button
                        type="submit"
                        @click="logout"
                        class="flex justify-between items-center px-4 py-4 tracking-wide w-full text-left text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus:bg-gray-100 focus:text-gray-900"
                    >
