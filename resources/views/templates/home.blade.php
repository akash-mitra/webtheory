...
<body>
    ...
    <div class="w-full max-w-6xl mx-auto px-6 font-reading">
        ...
        <div class="w-full mt-4">
            <nav>
                <div class="flex flex-no-wrap flex-col md:flex-row overflow-auto rounded-t-lg">
                    <span onclick="moduleMenuToggle()" class="text-teal-500 border border-teal-500 text-center mt-2 font-bold tracking-wide uppercase cursor-pointer p-4 rounded md:hidden">
                        Menu
                    </span>

                    <a href="/" class="menu-mod-item whitespace-no-wrap px-6 tracking-wide shadow-inner pt-3 pb-4 hover:bg-teal-600 hover:text-teal-100 text-lg hidden md:block">
                        Statistics
                    </a>
                    <a href="/" class="menu-mod-item whitespace-no-wrap px-6 tracking-wide shadow-inner pt-3 pb-4 hover:bg-teal-600 hover:text-teal-100 text-lg hidden md:block">
                        Data Transformation
        ...
        <div class="border-t-4 border-teal-500 w-full pattern rounded-b-lg px-10 py-8 overflow-scroll md:flex justify-center md:justify-between items-center">
            <div class="w-full md:w-1/3 max-w-xl flex justify-center md:justify-start">
            ...
            <div class="w-full md:w-2/3 max-w-4xl px-0 md:px-8">
                ...
                <h3 class="text-4xl text-gray-700 font-heading font-bold italic leading-tight">Evaluating Regression Models Performance</h3>
                <p class="py-4 text-lg text-gray-700">This course has been designed by two professional Data Scientists so that we can share our knowledge and help you learn complex theory, algorithms and coding libraries in a simple way.</p>
                <a href="#" class=" inline-block mt-4 text-teal-600 p-3 border-2 rounded border-teal-600 hover:bg-teal-600 hover:text-teal-100 font-bold">Continue Reading...</a>
            </div>
        </div>
        ...
        <div class="md:flex md:flex-wrap">
                ...
                <section class="w-full md:w-1/2 p-4">
                    ...
                    <header>
                        <h2 class="my-2 font-heading text-3xl">
                            <a href="#" class="text-gray-700 leading-tight hover:text-teal-500">
                                One Thousand and One Nights
                            </a>
                        </h2>
                    </header>
                    <div class="text-gray-800">
                        Several different variants of the story appear in the medieval One Thousand and One Nights, also known as the Arabian Nights, including "The Second Shaykh's Story", "The Eldest Lady's Tale" and "Abdallah ibn Fadil and His Brothers"
                    </div>
                    <footer>
                        <div class="text-sm mt-3 text-teal-600">
                            Published 1 months ago under Fairy Tales
                        </div>
                    </footer>
                </section>
                ...
                <section class="w-full md:w-1/2 p-4">
                    ...
                    <div class="text-gray-800">
                        The existing version of the Japanese tale dates back only the 13th century, but mention of it occurs in the early 11th-century Genji Monogatari (Tale of Genji).
                    </div>
                    <footer>
                        <div class="text-sm mt-3 text-teal-600">
                            Published 7 months ago under Fairy Tales
                        </div>
                    </footer>
                </section>
                ...
                <section class="w-full md:w-1/2 p-4">
                    ...
                    <footer>
                        <div class="text-sm mt-3 text-teal-600">
                            Published 7 months ago under Informatica
                        </div>
                    </footer>
                </section>
