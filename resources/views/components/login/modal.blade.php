    ...
    <div class="bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg text-left" @click.stop>
        ...
        <div v-if="mode==='signup'">
            <div class="py-6 px-6 flex justify-between items-center border-b">
                ...
                <div class="w-1/3 text-left text-3xl text-{{$color}}-600 font-light">Sign Up</div>

                <div class="-mt-16 bg-white p-4 shadow-lg rounded-full border inline-block">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-8 h-8 -mt-1 text-{{$color}}-700 fill-current">
                        <g>
                    ...
                    <div class="mt-4">
                        @if($captcha_site_key != "")
                            ...
                            <button onclick="submit_register_form(event)" type="button"
                                    class="w-full p-3 rounded border border-transparent rounded-md text-white font-semibold bg-{{$color}}-600 hover:bg-{{$color}}-700 focus:bg-{{$color}}-900 focus:outline-none focus:shadow-outline sm:text-sm sm:leading-5">
                                Sign Up
                            </button>
                        @else
                            <button type="submit"
        ...
        <div v-if="mode==='login'">
            ...
            <div class="p-6 flex justify-between items-center border-b">
                ...
                <div class="w-1/3 text-left text-3xl text-{{$color}}-600 font-light">Login
                </div>

                <div class="-mt-16 bg-white p-4 shadow-lg rounded-full border inline-block">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                         class="w-8 h-8 -mt-1 text-{{$color}}-700 fill-current">
                        <g>
                            <path class="secondary"
                                  d="M12 10v3a2 2 0 0 0-1 3.73V18a1 1 0 0 0 1 1v3H5a2 2 0 0 1-2-2v-8c0-1.1.9-2 2-2h7z" />
                            <path class="primary"
            ...
            @if(($data->ref->login->socialprovider->webtheory === 'On'))
                <div class="px-6 pt-6 shadow-inner">
                    ...
                    <form action="/login" method="POST">
                        ...
                        <div class="mt-6">
                            <button type="submit"
                                    class="w-full rounded p-3 border border-transparent rounded-md text-white font-semibold bg-{{$color}}-600 hover:bg-{{$color}}-700 focus:bg-{{$color}}-900 focus:outline-none focus:shadow-outline sm:text-sm sm:leading-5">
                                Log in
                            </button>
                        </div>
                    </form>
        ...
        @if(($data->ref->login->socialprovider->webtheory === 'On'))
            <div v-if="mode==='forgot'">
                <div class="py-6 px-6 flex justify-between items-center border-b">
                    ...
                    <div class="w-1/3 text-left text-3xl text-{{$color}}-600 font-light">
                        Recovery
                    </div>
