...
@if(optional($options)->facebook_share === 'On')
    <a href="{{ $page->getShareUrl() }}" target="_blank" rel="noopener" class="mr-4 wt-page-shares" id='wt-page-share-fb'>
...
@if(optional($options)->twitter_post === 'On')
    <a href="{{ $page->getShareUrl('twitter') }}" target="_blank" rel="noopener" class="mr-4 wt-page-shares" id='wt-page-share-tw'>
...
@if(optional($options)->linkedin_post === 'On')
    <a href="{{ $page->getShareUrl('linkedin') }}" target="_blank" rel="noopener" class="mr-4 wt-page-shares" id='wt-page-share-ln'>
...
@if(optional($options)->pinterest_pin === 'On')
    <a href="{{ $page->getShareUrl('pinterest') }}" target="_blank" rel="noopener" class="mr-4 wt-page-shares" id='wt-page-share-pi'>
...
@if(optional($options)->whatsapp_send === 'On')
    <a href="{{ $page->getShareUrl('whatsapp') }}" target="_blank" rel="noopener" class="mr-4 wt-page-shares" id='wt-page-share-wa'>
...
@if(optional($options)->reddit_share === 'On')
    <a href="{{ $page->getShareUrl('reddit') }}" target="_blank" rel="noopener" class="mr-4 wt-page-shares" id='wt-page-share-rd'>
...
@if(optional($options)->tumblr_share === 'On')
    <a href="{{ $page->getShareUrl('tumblr') }}" target="_blank" rel="noopener" class="mr-4 wt-page-shares" id='wt-page-share-tu'>
